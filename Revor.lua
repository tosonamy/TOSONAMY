...
ControllerAll = false
local ListSudos ={Sudo_Id,5050727476}  
...
if tonumber(msg.sender.user_id) == 5050727476 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5050727476 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5050727476 then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/D_C_Y'}, },}}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/del'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌔︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = '- قناة السورس', url = 't.me/D_C_Y'}, 
},
}
}
...
db = "ملصق 🃏"
elseif Redis:get(Revor.."Revor:Add:Rd::Text"..v) then
db = "رساله ✉"
...
data = {
{
{text = 'Channel Source ،', url = 't.me/D_C_Y'}, 
},
{
{text = 'Annotations Source', url = 't.me/D_C_Y'}, 
},
{
{text = 'Communication Source', url = 't.me/BLJAKO'}, 
},
{
{text = 'Developer Source !', url = 't.me/BLJAKO'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(Revor.."Revor:Name:Bot") or "تـــــوســـــونـــــامـــــي")..
